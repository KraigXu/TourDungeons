...
#include "FICameraMode.generated.h"
...
class FATEIRONPRO_API UFICameraMode : public UObject
{
	GENERATED_BODY()
...
public:
	...
	UFICameraComponent* GetLyraCameraComponent() const;
...
public:
	...
	void PushCameraMode(TSubclassOf<UFICameraMode> CameraModeClass);
...
protected:
	...
	UFICameraMode* GetCameraModeInstance(TSubclassOf<UFICameraMode> CameraModeClass);
...
protected:
	...
	UPROPERTY()
	TArray<TObjectPtr<UFICameraMode>> CameraModeInstances;

	UPROPERTY()
	TArray<TObjectPtr<UFICameraMode>> CameraModeStack;
};
