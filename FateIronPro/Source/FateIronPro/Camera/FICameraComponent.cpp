...
UFICameraComponent::UFICameraComponent(const FObjectInitializer& ObjectInitializer)
...
void UFICameraComponent::OnRegister()
{
	Super::OnRegister();
...
void UFICameraComponent::GetCameraView(float DeltaTime, FMinimalViewInfo& DesiredView)
{
	// check(CameraModeStack);
	//
	// UpdateCameraModes();
...
void UFICameraComponent::UpdateCameraModes()
{
	// check(CameraModeStack);
	//
...
void UFICameraComponent::DrawDebug(UCanvas* Canvas) const
{
	check(Canvas);
...
void UFICameraComponent::GetBlendInfo(float& OutWeightOfTopLayer, FGameplayTag& OutTagOfTopLayer) const
{
	//check(CameraModeStack);
