...
public:
	...
	UPROPERTY(EditDefaultsOnly, BlueprintReadOnly, config, Category=FateIron, meta=(AllowedTypes="FIExperienceDefinition"))
...
public:
	...
	FATEIRONPRO_API void OnPlayInEditorStarted() const;
