 ...
 */
UCLASS(HideDropdown,Config = Game, Meta = (ShortTooltip = "The base game mode class used by this project."))
...
public:
	...
	const UFIPawnData* GetPawnDataForController(const AController* InController) const;
