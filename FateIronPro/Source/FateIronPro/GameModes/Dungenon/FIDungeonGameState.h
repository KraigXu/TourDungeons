 ...
 */
UCLASS(HideDropdown, Config = Game)
class FATEIRONPRO_API AFIDungeonGameState : public AModularGameStateBase, public IAbilitySystemInterface
{
	GENERATED_BODY()

public:

	AFIDungeonGameState(const FObjectInitializer& ObjectInitializer = FObjectInitializer::Get());
