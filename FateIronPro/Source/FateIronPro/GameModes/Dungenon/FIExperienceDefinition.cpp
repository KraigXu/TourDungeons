...
#include UE_INLINE_GENERATED_CPP_BY_NAME(FIExperienceDefinition)

#define LOCTEXT_NAMESPACE "LyraSystem"

UFIExperienceDefinition::UFIExperienceDefinition()
{
}

#if WITH_EDITOR
EDataValidationResult UFIExperienceDefinition::IsDataValid(FDataValidationContext& Context) const
{
...
void UFIExperienceDefinition::UpdateAssetBundleData()
{
