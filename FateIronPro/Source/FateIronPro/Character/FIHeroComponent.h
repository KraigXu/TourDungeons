...
#include "FIHeroComponent.generated.h"
...
class FATEIRONPRO_API UFIHeroComponent : public UPawnComponent, public IGameFrameworkInitStateInterface
{
	GENERATED_BODY()

public:

	UFIHeroComponent(const FObjectInitializer& ObjectInitializer);
	...
	void AddAdditionalInputConfig(const UFIInputConfig* InputConfig);

	/** Removes a mode-specific input config if it has been added */
	void RemoveAdditionalInputConfig(const UFIInputConfig* InputConfig);
