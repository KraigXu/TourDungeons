...
#include "FIAbilityTagRelationshipMapping.generated.h"

class UObject;

/** Struct that defines the relationship between different ability tags */
USTRUCT()
struct FFIAbilityTagRelationship
{
	GENERATED_BODY()
...
UCLASS()
class FATEIRONPRO_API UFIAbilityTagRelationshipMapping : public UDataAsset
{
	GENERATED_BODY()
...
private:
	...
	TArray<FFIAbilityTagRelationship> AbilityTagRelationships;
