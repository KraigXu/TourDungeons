...
#include "FIGameplayAbility.generated.h"
...
/**
 * EFIAbilityActivationPolicy
 *
 *	Defines how an ability is meant to activate.
 */
UENUM(BlueprintType)
enum class EFIAbilityActivationPolicy : uint8
{
...
/**
 * EFIAbilityActivationGroup
 *
 *	Defines how an ability activates in relation to other abilities.
 */
UENUM(BlueprintType)
enum class EFIAbilityActivationGroup : uint8
{
...
struct FFIAbilityMontageFailureMessage
{
	GENERATED_BODY()
...
class FATEIRONPRO_API UFIGameplayAbility : public UGameplayAbility
{
	GENERATED_BODY()
	friend class UFIAbilitySystemComponent;

public:

	UFIGameplayAbility(const FObjectInitializer& ObjectInitializer = FObjectInitializer::Get());
	...
	bool CanChangeActivationGroup(EFIAbilityActivationGroup NewGroup) const;
...
protected:
	...
	EFIAbilityActivationPolicy ActivationPolicy;

	// Defines the relationship between this ability activating and other abilities activating.
	UPROPERTY(EditDefaultsOnly, BlueprintReadOnly, Category = "Lyra|Ability Activation")
	EFIAbilityActivationGroup ActivationGroup;

	// Additional costs that must be paid to activate this ability
	UPROPERTY(EditDefaultsOnly, Instanced, Category = Costs)
	TArray<TObjectPtr<UFIAbilityCost>> AdditionalCosts;
