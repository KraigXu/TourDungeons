...
#include "FIAbilityCost.generated.h"
...
class FATEIRONPRO_API UFIAbilityCost : public UObject
{
	GENERATED_BODY()
...
public:
	 ...
	 */
	virtual bool CheckCost(const UFIGameplayAbility* Ability, const FGameplayAbilitySpecHandle Handle, const FGameplayAbilityActorInfo* ActorInfo, FGameplayTagContainer* OptionalRelevantTags) const
	{
		return true;
	}
	 ...
	 */
	virtual void ApplyCost(const UFIGameplayAbility* Ability, const FGameplayAbilitySpecHandle Handle, const FGameplayAbilityActorInfo* ActorInfo, const FGameplayAbilityActivationInfo ActivationInfo)
	{
	}
