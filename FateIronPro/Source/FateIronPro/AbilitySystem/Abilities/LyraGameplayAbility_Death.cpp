	...
	: Super(ObjectInitializer)
{
	...
	if (HasAnyFlags(RF_ClassDefaultObject))
	{
		...
		TriggerData.TriggerTag = FIGameplayTags::GameplayEvent_Death;
...
void ULyraGameplayAbility_Death::ActivateAbility(const FGameplayAbilitySpecHandle Handle, const FGameplayAbilityActorInfo* ActorInfo, const FGameplayAbilityActivationInfo ActivationInfo, const FGameplayEventData* TriggerEventData)
{
	...
	AbilityTypesToIgnore.AddTag(FIGameplayTags::Ability_Behavior_SurvivesDeath);
	...
	// {
	// 	UE_LOG(LogFIAbilitySystem, Error, TEXT("ULyraGameplayAbility_Death::ActivateAbility: Ability [%s] failed to change activation group to blocking."), *GetName());
	// }
